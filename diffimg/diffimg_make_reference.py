...
def resamp_image(input_image, output_image, 
    ...
    xra_center, xdec_center  = utl.d2hms(ra_center, dec_center, conv=0)
    ...
    image_header["REF_RAS"]  = (xra_center, "RA of image center [hhmmss]")
    image_header["REF_DECS"] = (xdec_center, "DEC of image center [ddmmss]")
